...
/*   Updated: 2023/05/22 15:01:38 by mcatal-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    {
        ...
        // const Animal* meta = new Animal(); // Error: Animal is abstract
        ...
        // meta->makeSound(); // Error: Animal is abstract

        // delete  meta; // Error: Animal is abstract
        delete  j;
        delete  i;
    }
